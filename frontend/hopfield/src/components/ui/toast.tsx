...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-slate-950 opacity-0 transition-opacity hover:bg-slate-100 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-slate-950 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:bg-red-400 group-[.destructive]:hover:text-white group-[.destructive]:focus:ring-red-400",
      className,
    )}
    toast-close=""
    {...props}
